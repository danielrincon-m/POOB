...
public class Sinap {
     ...
     */
    public void adicioneCinco() throws SINAPExcepecion{
        Area ejemplos[] = {
                new Area("Ciénaga Grande de Santa Marta", "Large Marsh of Saint Martha", "Madalena", "4280",
                        "Santuario de flora y fauna." +
                                ...
                                " humedal Ramsar."),
                new Area("Nevado del Huila", "Nevado del Huila", " Huila, Tolima, Cauca", "1.580",
                        "Parque natural" +
                ...
                new Area("Laguna de Sonso", "Laguna de Sonso", "Valle del Cauca", " 14.1",
                        "Reserva natural," +
                ...
                new Area("Morichales de Paz de Ariporo", "Morichales de Paz de Ariporo", "Casanare", "2400",
                ...
                new Area("Parque Isla de Salamanca", "Salamanca Island Road Park", "Magalena", " 	562",
                        "Vía parque'." +
     ...
     * @param descripcion
     */
    public void adicione(String nombre, String name, String ubicacion, String area, String descripcion) throws SINAPExcepecion{
     ...
     */
    public void adicioneDetalles(Area detalles) throws SINAPExcepecion{
        int i = 0;
        //El área no se debe repetir
        for (Area area : areas){
            if (area.getNombre().compareToIgnoreCase(detalles.getNombre()) == 0) {
                throw new SINAPExcepecion(SINAPExcepecion.AREA_DUPLICADA);
            }
        }
